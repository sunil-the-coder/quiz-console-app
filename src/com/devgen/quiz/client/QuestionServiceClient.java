...
public class QuestionServiceClient {
	...
	public static void main(String[] args) {
		...
		Question question2 = new Question(7, "Java Born year", new String[] {"1885", "1920", "1995", "2005"}, 3);		
		questionService.addQuestion(question2);
		
		Question question3 = new Question(8, "Java Born year", new String[] {"1885", "1920", "1995", "2005"}, 3);		
		questionService.addQuestion(question3);
		
		Question question4 = new Question(9, "Java Born year",new String[] { "1885", "1920", "1995", "2005"}, 3);		
		questionService.addQuestion(question4);
		
		Question question5 = new Question(6, "Java Born year",new String[] { "1885", "1920", "1995", "2005"}, 3);		
